...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_profile__ = __webpack_require__(785);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular_navigation_view_controller__ = __webpack_require__(11);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserProfilePage = (function () {
    function UserProfilePage(navParams, view, httpProvider, modalCtrl, timeProvider) {
    ...
    UserProfilePage.prototype.getPosts = function () {
        ...
        this.httpProvider.getPostsById(this.uid).subscribe(function (postsData) {
            ...
            _this.postsData = postsData.posts.data;
            console.log(_this.postsData);
            try {
                for (var _i = 0, _a = _this.postsData; _i < _a.length; _i++) {
                    var data = _a[_i];
    ...
    UserProfilePage.prototype.getContext = function () {
        ...
        this.httpProvider.getContext(this.uid).subscribe(function (contextData) {
            ...
            if (_this.type == "friends") {
                ...
                _this.friends_who_like = contextData.context.friends_who_like.data;
                _this.friends_who_like_count = contextData.context.friends_who_like.summary.total_count;
            }
            _this.getPosts();
    ...
    UserProfilePage.prototype.presentProfileModal = function (uid, user_name, typeID) {
        //console.log(uid);
        var profileModal = this.modalCtrl.create('UserProfilePage', { userId: uid, name: user_name, type: typeID });
...
>>>>>>> 7a09dce78497caf0f0ecd5e219bb617ed369535f
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular_navigation_view_controller__["a" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1__providers_http_http_provider__["a" /* HttpProvider */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["h" /* ModalController */], __WEBPACK_IMPORTED_MODULE_0__providers_time_time__["a" /* TimeProvider */]])
], UserProfilePage);
